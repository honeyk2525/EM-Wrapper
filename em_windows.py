#!/usr/bin/env python3
"""
GROMACS Runner — Windows Desktop Application
=============================================
...
Workflow (per file):
  ...
  2. All runs start simultaneously, each in its own thread
...
Features:
  - Select up to 25+ PDB files; all run simultaneously
...
Requirements:
  ...
  - Python 3.8+ with tkinter (included with standard Windows Python)

Usage:
  python gmx_runner_windows.py

Packaging (Windows .exe):
  pip install pyinstaller
  pyinstaller --windowed --onefile gmx_runner_windows.py
"""
...
# =============================================================================
# Windows-safe command quoting
# =============================================================================

def win_quote(s: str) -> str:
    """Wrap a path/argument in double quotes for Windows CMD."""
...
class GromacsPipeline:
    ...
    def run(self) -> bool:
        ...
        # win_quote produces double-quoted tokens safe for Windows CMD
        q = win_quote
        f_pdb = q(f"{name}.pdb")
...
class SettingsDialog(tk.Toplevel):
    ...
    def __init__(self, parent, cfg: dict):
        ...
        tk.Label(
            frame, text="GROMACS binary path:", font=("Segoe UI", 11),
        ...
        tk.Label(
            ...
            text='Default: "gmx" (uses PATH).\n'
                 r'Example: C:\Program Files\GROMACS\bin\gmx.exe',
            font=("Segoe UI", 9),
            fg="#666666",
            justify=tk.LEFT,
...
class GromacsRunnerApp:
    ...
    def _build_ui(self):
        ...
        self.btn_select = tk.Button(
            ...
            width=14, font=("Segoe UI", 12, "bold"),
        )
        self.btn_select.pack(side=tk.LEFT)

        tk.Label(row1, text="  Force Field:", font=("Segoe UI", 11)).pack(
            side=tk.LEFT,
        )
        ...
        self.btn_cancel = tk.Button(
            ...
            width=10, state=tk.DISABLED, font=("Segoe UI", 10),
            fg="#cc3333",
        )
    ...
    def _on_job_select(self, _event=None):
        ...
        # Enable open folder if this job has finished output
    ...
    # ------------------------------------------------------------------
    # PDB selection → launch all pipelines simultaneously
    # ------------------------------------------------------------------
